...
public class CryptoUtils {
	...
	public static void decryptSISOP(String key,byte [] encrypted,byte[] output) throws CryptoException{
		doCrypto(Cipher.DECRYPT_MODE,key,encrypted,output);
	}
	private static void doCrypto(int cipherMode,String key,byte[] input,byte[] output) throws CryptoException {
		try{
